...
if(!isset($_SESSION["_USer"]->identificacion)){
...
include("../clases/MapaConceptual.php");
include("../clases/StandAlone.php");
include("../clases/SopaLetras.php");
...
function refrescarEstadoMapa(){
	...
	$QueryMapas=pg_query("SELECT id_mapa_conceptual as id, fecha_limite as feclim FROM mapa_conceptual 
...
$VectorDatos=obtenerDatos($_SESSION["_User"]->identificacion);
...
<link rel="stylesheet" type="text/css" href="../css/EstiloPrincipal.css"></link>
<?php
$Xajax->printJavascript("lib/xajax/");
if($VectorDatos->nombrePerfil=="Docente"){
?>
...
<td colspan="2">
	...
	<tr>
	<td align="left">
	&nbsp;&nbsp;Bienvenido(a) <?php echo strtolower($_SESSION["_User"]->nombrePerfil).", ".ucwords(strtolower($VectorDatos->nombreUsuario." ".$VectorDatos->apellidoUsuario));?>
	</td>
	<td align="right">
	<?php echo date("d M Y")?>&nbsp;&nbsp;
	</td>
...
<td align="center" width="22%" valign="top">
	...
	switch($VectorDatos->nombrePerfil){
		case "Docente":
			echo "<tr><td><a href='javascript:void(0)' onClick=\"xajax_cargarGrupos('".$_SESSION["_User"]->identificacion."');\">Mis Grupos</a></td></tr>";
			echo "<tr><td><a href='javascript:void(0)' onClick=\"mostrarPerfil('".$VectorDatos->nombreUsuario."','".$VectorDatos->apellidoUsuario."','".$VectorDatos->nombrePerfil."','".$VectorDatos->mail."');\">Mi Perfil</a></td></tr>";
			...
			echo "<tr><td><a href='javascript:void(0)' onClick=\"xajax_cargarListadoEstadisticas('".$_SESSION["_User"]->identificacion."');\">Estad&iacute;sticas</a></td></tr>";
		break;
		case "Estudiante":
